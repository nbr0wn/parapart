...
function StlViewer(parent_element_obj, options)
{
	...
	{
		if(model_worker != null){
			model_worker.terminate();
			model_worker=undefined;
		}
		model_worker=new Worker(((typeof _this.load_three_files == "string")?_this.load_three_files:"")+"load_stl.min.js");
	...
	{
        //console.log("set_zoom", zoom, force_zoom);
	...
	this.calc_z_for_auto_zoom=function (offset)
	{
		...
		// NSB - Scale the bounding box by 1.25 to ensure the object fits comfortably in the camera view
		size.x *= 1.25;
		size.y *= 1.25;
		size.z *= 1.25;
